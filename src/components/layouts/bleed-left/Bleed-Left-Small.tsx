...
export const BleedLeftSmall = (
  ...
  return (
    <div class="grid grid-cols-26 w-full">
      <div class="col-span-full sm:col-span-13 xl:col-span-10">{Left()}</div>
      <div class="col-start-2 sm:col-start-0 col-span-24 sm:col-span-11 xl:col-span-12">
        {Right()}
      </div>
    </div>
  );
