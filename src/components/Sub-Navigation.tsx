...
export default function SubNavigation() {
  ...
  // });
  return (
    <nav class="pt-8 sm:py-4 md:py-8 lg:py-12 w-full sm:w-auto flex flex-col gap-3 transition-all bg-3a-gray-darkest">
      <h3 class="px-4 sm:px-8 pb-8 text-3a-green">Content</h3>
      <ul style={{ "--menu-y": `0px` }}>
        ...
        <li class="border-t border-t-3a-gray border-dashed pt-2 mt-2 px-4 sm:px-8">
